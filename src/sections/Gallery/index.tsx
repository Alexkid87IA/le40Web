...
interface GalleryImage {
  url: string;
  caption: string;
  category: 'coworking' | 'event' | 'meeting' | 'creative' | 'studio' | 'podcast' | 'broadcast';
}
...
const images: GalleryImage[] = [
  ...
  },
  {
    ...
    caption: 'Salle de Réunion Créative',
    category: 'meeting'
  },
  {
  ...
  },
  {
    ...
    caption: 'Salle Créative avec Tableaux',
    category: 'creative'
  },
  {
  ...
  },
  {
    ...
    caption: 'Poste de Travail Chromakey',
    category: 'studio'
  },
  {
  ...
  },
  {
    ...
    caption: 'Configuration Podcast 4 Places',
    category: 'podcast'
  },
  {
...
const categories = [
  ...
  { id: 'creative', label: 'Espaces Créatifs' },
          ...
          {filteredImages.slice(0, 8).map((image, index) => (
            <motion.button
              ...
              className={`relative aspect-video rounded-xl overflow-hidden ${
                index === currentIndex ? 'ring-4 ring-amber-500' : 'ring-1 ring-white/10'
              }`}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
