        ...
        <div className="text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-xl border border-white/10">
              ...
              <span className="text-xs font-inter font-medium text-white/80 tracking-wide uppercase">Espaces Premium</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.div
                className="absolute -inset-2 bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 blur-2xl -z-10"
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-white/70 font-inter text-xs">
                <span className="text-emerald-400 font-semibold">500+ événements</span> réussis
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <motion.div
                className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-xl opacity-75 blur-lg group-hover:opacity-100 transition-opacity duration-300"
                animate={{ opacity: [0.5, 0.75, 0.5] }}
                transition={{ duration: 2, repeat: Infinity }}
              />
              <div className="relative flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl font-montserrat font-bold text-sm shadow-2xl">
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-6 h-6 rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 border-2 border-black flex items-center justify-center text-white font-bold text-[10px]">
