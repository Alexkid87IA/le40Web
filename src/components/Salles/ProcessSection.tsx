      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-16">
              ...
              >
                ...
                <div className="relative bg-zinc-900/80 backdrop-blur-xl rounded-3xl p-8 border border-white/10 group-hover:border-white/30 transition-all duration-500 h-full">
                  <div className="relative mb-6">
                    ...
                    <div className="absolute -top-3 -right-3 w-12 h-12 rounded-full bg-black border-2 border-white/20 flex items-center justify-center">
                  ...
                  <p className="text-white/70 font-inter leading-relaxed text-center">
                    {step.description}
                  </p>
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="group inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 text-white rounded-2xl font-montserrat font-bold text-lg shadow-2xl"
          >
