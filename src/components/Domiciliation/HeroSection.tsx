  ...
  return (
    <section ref={containerRef} className="relative min-h-screen flex items-center overflow-hidden py-16 lg:py-8">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <motion.div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-orange-600/10 rounded-full blur-[150px]"
          animate={{
            scale: [1, 1.2, 1],
            opacity: [0.1, 0.2, 0.1]
          }}
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-amber-600/10 rounded-full blur-[150px]"
          animate={{
            scale: [1.2, 1, 1.2],
        ...
        <div className="text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-xl border border-white/10">
              ...
              <span className="text-xs font-inter font-medium text-white/80 tracking-wide uppercase">Agréé Préfecture · Conformité Totale</span>
            </div>
          </motion.div>
          ...
          >
            ...
            <span className="relative inline-block">
              ...
              <motion.div
                className="absolute -inset-2 bg-gradient-to-r from-orange-500/20 via-amber-500/20 to-orange-500/20 blur-2xl -z-10"
                animate={{
                  opacity: [0.5, 0.8, 0.5],
                  scale: [1, 1.05, 1]
                }}
          ...
          >
            <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-orange-500/10 border border-orange-400/20 backdrop-blur-sm">
          ...
          >
            ...
            >
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
              />
              <div className="relative flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 text-white rounded-xl font-montserrat font-bold text-sm shadow-2xl">
          ...
          >
            ...
            <div className="flex items-center gap-1.5">
              <div className="flex -space-x-2">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="w-6 h-6 rounded-full bg-gradient-to-br from-orange-500 via-amber-500 to-orange-600 border-2 border-black flex items-center justify-center text-white font-bold text-[10px]">
                    {String.fromCharCode(64 + i)}
                  </div>
                ))}
              </div>
              <span className="text-white/60 text-xs font-inter">+120 entreprises</span>
            </div>
          </motion.div>
        </div>
      </div>
