    ...
    <section ref={containerRef} className="relative min-h-screen flex items-center overflow-hidden bg-black">
      <div className="absolute inset-0">
        ...
        >
          ...
          >
            <source
              src="https://res.cloudinary.com/dwt7u0azs/video/upload/v1761805289/e3c2235d-6478-42d0-85b3-6266f2227367_iazq5a.mp4#t=0.1"
              type="video/mp4"
            />
          </video>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-16 py-12 md:py-20 w-full">
        <div className="text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 mb-6 md:mb-8">
              <Shield className="w-4 md:w-5 h-4 md:h-5 text-orange-400" />
              <span className="text-xs md:text-sm font-inter font-medium text-white/80 tracking-wide uppercase">Agréé Préfecture · Conformité Totale</span>
            </div>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-base md:text-lg lg:text-xl text-white/70 font-inter max-w-4xl mx-auto mb-8 md:mb-12 leading-relaxed px-4"
          >
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-8 md:mb-12 px-4"
          >
          ...
          <motion.div
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 max-w-5xl mx-auto mb-8 md:mb-16 px-4"
          >
            {[
              { value: '39€', suffix: '/m', label: 'À partir de', color: 'from-orange-500 via-amber-600 to-orange-500' },
              ...
              >
                ...
                <div className="relative bg-black/50 backdrop-blur-xl border border-white/10 rounded-2xl md:rounded-3xl p-4 md:p-8 group-hover:border-white/20 transition-all duration-500">
                  <div className={`text-3xl md:text-4xl lg:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r ${stat.color} mb-1 md:mb-2`}>
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6 mb-8 md:mb-12 px-4"
          >
            <motion.a
              href="#pricing"
            ...
            >
              <motion.div
                ...
                transition={{ duration: 2, repeat: Infinity }}
              />
              <div className="relative flex items-center gap-2 md:gap-3 px-6 md:px-10 py-3 md:py-5 bg-gradient-to-r from-orange-500 via-amber-500 to-orange-500 text-white rounded-xl font-montserrat font-bold text-sm md:text-lg shadow-2xl">
                <span>Voir les forfaits</span>
                <ArrowRight className="w-4 md:w-6 h-4 md:h-6 group-hover:translate-x-1 transition-transform duration-300" />
              </div>
            </motion.a>
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05, y: -2 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 md:px-10 py-3 md:py-5 bg-white/10 hover:bg-white/20 backdrop-blur-xl border border-white/20 hover:border-white/40 text-white rounded-xl font-montserrat font-bold text-sm md:text-lg transition-all duration-300"
            >
              Nous contacter
            </motion.a>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl md:rounded-2xl p-4 md:p-6 text-center group hover:bg-white/10 hover:border-white/20 transition-all duration-300"
              >
                <benefit.icon className={`w-6 md:w-8 h-6 md:h-8 ${benefit.color} mx-auto mb-2 md:mb-3 group-hover:scale-110 transition-transform duration-300`} />
