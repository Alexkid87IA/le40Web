...
export default function ProcessSection() {
  ...
  return (
    <section ref={sectionRef} className="relative py-32 bg-gradient-to-b from-black via-zinc-950 to-black overflow-hidden">
      ...
      <motion.div style={{ opacity, scale }} className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        <SectionHeader
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="relative p-8 lg:p-10 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 backdrop-blur-xl rounded-2xl border border-white/[0.08] group-hover:border-white/[0.15] transition-all duration-500 h-full">
                    <motion.div
                      ...
                      <div className="flex items-start justify-between mb-8">
                        <div className="flex items-center gap-4">
                          <motion.div
                            ...
                            className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${step.gradient} flex items-center justify-center shadow-xl`}
                            style={{
                          ...
                          <div>
                            ...
                            <div className="text-white/90 font-montserrat font-bold text-lg">
                              {step.title}
                            </div>
                          </div>
                        </div>

                        <div className="text-6xl font-black text-white/[0.03] font-montserrat">
                          {step.number}
                        </div>
                      </div>
                        ...
                        <ul className="space-y-3">
                          {step.items.map((item, i) => (
                            ...
                            >
                              ...
                              <span className="text-white/70 group-hover/item:text-white/90 transition-colors font-inter leading-relaxed">
                                {item}
                              </span>
                            </motion.li>
                          ))}
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.98 }}
            className="group relative inline-flex items-center gap-3 px-10 py-5 bg-white text-black rounded-xl font-bold text-lg overflow-hidden shadow-2xl"
          >
            <motion.div
            ...
            />
            <span className="relative z-10 font-montserrat group-hover:text-white transition-colors">
              Démarrer maintenant
            </span>
            <motion.div
              animate={{ x: [0, 5, 0] }}
