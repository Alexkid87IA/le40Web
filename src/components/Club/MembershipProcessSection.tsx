    ...
    <section className="py-32 bg-slate-950 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          ...
          >
            <div className="absolute -inset-1 bg-gradient-to-r from-red-600 to-rose-600 rounded-2xl blur-xl opacity-70 group-hover:opacity-100 transition-opacity" />
            <div className="relative flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-red-500 via-rose-500 to-pink-500 rounded-2xl">
