      ...
      <div className={`relative h-full bg-gradient-to-br ${plan.isMostPopular ? 'from-white/15 to-white/10' : 'from-white/10 to-white/5'} backdrop-blur-xl border ${plan.isMostPopular ? 'border-emerald-500/30' : 'border-white/10'} rounded-3xl p-8 group-hover:border-white/20 transition-all`}>
        ...
        <div className="space-y-4">
          {plan.features.map((feature, idx) => (
            ...
            >
              <Check className={`w-5 h-5 ${plan.isMostPopular ? 'text-emerald-400' : 'text-orange-400'} flex-shrink-0 mt-0.5`} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        >
          <motion.span
            ...
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-500/20 text-sm font-semibold text-orange-400 mb-6"
          >
          ...
          <div className="bg-gradient-to-r from-white/5 to-white/10 backdrop-blur-xl border border-white/10 rounded-3xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center p-6 bg-white/5 rounded-2xl">
                <div className="text-white/60 text-sm mb-2">2 Masterclasses</div>
                <div className="text-2xl font-bold text-white">300€</div>
              </div>
              <div className="text-center p-6 bg-white/5 rounded-2xl">
                <div className="text-white/60 text-sm mb-2">4 Ateliers</div>
                <div className="text-2xl font-bold text-white">320€</div>
              </div>
              <div className="text-center p-6 bg-white/5 rounded-2xl">
                <div className="text-white/60 text-sm mb-2">+ Networking</div>
                <div className="text-2xl font-bold text-white">Inestimable</div>
              </div>
            </div>
            ...
            >
              <p className="text-white/80 mb-2">Valeur totale réelle : <span className="font-bold text-white">+600€/mois</span></p>
              ...
              <p className="text-emerald-400 font-bold mt-2">Soit 92% d'économies !</p>
            </motion.div>
          </div>
        </motion.div>
