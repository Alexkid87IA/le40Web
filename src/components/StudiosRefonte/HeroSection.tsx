        ...
        <div className="text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 md:px-6 py-2 md:py-3 rounded-full bg-white/5 backdrop-blur-xl border border-white/10 mb-6 md:mb-8">
              <Video className="w-4 h-4 md:w-5 md:h-5 text-emerald-400" />
              <span className="text-xs md:text-sm font-inter font-medium text-white/80 tracking-wide uppercase">Studios Premium 4K</span>
            </div>
          </motion.div>
          ...
          <motion.p
            ...
            className="text-sm sm:text-base md:text-lg lg:text-xl text-white/70 max-w-4xl mx-auto mb-8 md:mb-12 leading-relaxed font-inter px-4"
          >
          ...
          >
            ...
            >
              ...
              />
              <div className="relative flex items-center gap-2 md:gap-3 px-6 md:px-8 py-3 md:py-4 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 text-white rounded-xl font-montserrat font-bold shadow-2xl text-sm md:text-base">
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto mb-12 md:mb-16"
          >
            {[
          ...
          >
            <div className="flex items-center gap-2">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div key={i} className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-500 border-2 border-black flex items-center justify-center text-white font-bold text-xs">
                    {String.fromCharCode(64 + i)}
                  </div>
                ))}
              </div>
              <span className="text-white/60 text-xs md:text-sm font-inter">200+ créateurs actifs</span>
            </div>
