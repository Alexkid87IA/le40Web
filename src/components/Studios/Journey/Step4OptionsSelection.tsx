  ...
  return (
    <section className="py-16 bg-gradient-to-b from-slate-900 via-slate-950 to-black">
      <div className="max-w-7xl mx-auto px-8">
        ...
        >
          <div className="inline-flex items-center gap-2 mb-6 px-5 py-2.5 rounded-full bg-gradient-to-r from-orange-500/10 to-amber-500/10 border border-orange-400/30 backdrop-blur-xl">
            <Sparkles className="w-4 h-4 text-orange-400" />
            <span className="text-orange-300 font-inter text-sm font-bold">Étape 4 sur 4</span>
          </div>
          ...
          >
            {displayedRecommendations.map((rec, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className="absolute -inset-1 bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl blur-xl transition-all duration-500"
                  ...
                  <div className={`relative bg-slate-900/90 backdrop-blur-2xl rounded-2xl p-6 border-2 transition-all duration-500 h-full flex flex-col ${
                    isSelected ? 'border-orange-400' : 'border-white/10 group-hover:border-white/20'
                  }`}>
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        ...
                        {rec.reason && (
                          <div className="flex items-start gap-2 bg-orange-500/10 border border-orange-400/20 rounded-lg p-2">
                            <Info className="w-4 h-4 text-orange-400 flex-shrink-0 mt-0.5" />
                            <p className="text-orange-300 text-xs font-inter leading-snug">
                              {rec.reason}
                            </p>
                          </div>
                        )}
                    ...
                    <div className="mt-auto">
                      <div className="mb-4">
                        <div className="flex items-baseline gap-2">
                          <span className="text-3xl font-montserrat font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">
                            {option.price}€
                          </span>
                      ...
                      <AnimatePresence mode="wait">
                        {!isSelected ? (
                          <motion.button
                            ...
                            className="w-full bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white py-3 rounded-xl font-montserrat font-bold flex items-center justify-center gap-2"
                          >
                          ...
                          >
                            ...
                            <motion.button
                              ...
                              whileTap={{ scale: 0.9 }}
                              onClick={() => updateQuantity(rec.optionId, 1)}
                              className="w-10 h-10 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 rounded-lg flex items-center justify-center text-white"
                            >
                              <Plus className="w-5 h-5" />
                            </motion.button>
                          </motion.div>
        ...
        >
          {totalSelected > 0 && (
            <div className="bg-slate-900/90 backdrop-blur-xl border border-orange-400/30 rounded-2xl p-6 w-full max-w-2xl">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-3xl font-montserrat font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-400">
                    +{optionsTotal}€
                  </div>
                </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={onContinue}
            className="bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white px-12 py-5 rounded-xl font-montserrat font-bold text-lg flex items-center gap-3 shadow-2xl"
          >
