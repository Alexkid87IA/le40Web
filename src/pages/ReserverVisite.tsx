          ...
          <div className="p-8 sm:p-10 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="mt-8 pt-8 border-t border-white/10">
                <p className="text-center text-white/60 font-inter mb-4">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center justify-center gap-3 w-full py-4 bg-white/10 hover:bg-white/20 border border-white/20 rounded-xl text-white font-montserrat font-bold transition-all"
                >
