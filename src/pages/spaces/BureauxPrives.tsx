...
import { Users, Shield, Building2, Clock, ArrowRight, Star, Check, Calendar, Phone, Wifi } from 'lucide-react';
import SidebarNav from '../../components/Nav/SidebarNav';
import MobileBurger from '../../components/Nav/MobileBurger';
import Footer from '../../components/Footer';

const spaceFeatures = [
  "Bureaux fermés de 2 à 6 personnes",
  "Mobilier haut standing inclus",
  "Climatisation individuelle",
  "Accès illimité aux salles de réunion",
  "2h de salle de réunion/mois incluses",
  "Branding possible sur la porte",
  "Casiers de rangement sécurisés",
...
const testimonials = [
  {
    ...
    comment: "Notre bureau privé nous offre la confidentialité nécessaire pour nos réunions stratégiques tout en gardant l'énergie du coworking.",
    rating: 5,
  ...
  },
  {
    ...
    comment: "Parfait pour recevoir mes clients dans un cadre professionnel. Le mobilier est de qualité et l'espace très bien pensé.",
    rating: 5,
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Votre cocon pro, prêt à l'emploi
              </p>

              {/* Quick Stats */}
              <div className="flex flex-wrap justify-center gap-8 text-white mb-8">
                {[
                  { icon: Users, text: '2-6 personnes', color: 'text-purple-400' },
                  { icon: Shield, text: 'Accès sécurisé', color: 'text-green-400' },
                  { icon: Clock, text: '24/7 + alarme', color: 'text-blue-400' }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-400 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <p className="text-gray-300 text-lg leading-relaxed mb-8">
                  Bureaux fermés de 2 à 6 personnes, mobilier haut standing, climatisation, accès illimité aux salles de réunion 2 h/mois et branding possible sur la porte. Parfait pour les équipes en croissance ou les consultants exigeants.
                </p>
              ...
              >
                <div className="relative h-96 rounded-3xl overflow-hidden">
                  <img
                    ...
                    alt="Bureau privé vue d'ensemble"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {spaceGallery.map((image, index) => (
                ...
                >
                  <img
                    src={image}
                    alt={`Vue ${index + 1} des bureaux privés`}
          ...
          <div className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16 text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Contactez-nous pour une visite personnalisée et un devis sur mesure
              </p>
