#!/usr/bin/env node
/**
 * Upload des vidéos promotionnelles 9:16 vers Bunny.net
 */
...
const VIDEOS = [
  {
    localPath: '/Users/alexquilghini1/Downloads/Videos/video9:16hero/videohero916.mp4',
    remotePath: 'videos/promo/hero-promo-916.mp4',
    description: 'Hero promo (9:16)'
  },
  {
    localPath: '/Users/alexquilghini1/Downloads/Videos/video9:16hero/video916bureau.mp4',
    remotePath: 'videos/promo/bureau-promo-916.mp4',
    description: 'Bureau promo (9:16)'
  },
  {
    localPath: '/Users/alexquilghini1/Downloads/Videos/video9:16hero/videoherodomiciliation.mp4',
    remotePath: 'videos/promo/domiciliation-promo.mp4',
    description: 'Domiciliation promo'
  }
];
...
async function main() {
  ...
  console.log('Upload des vidéos promotionnelles 9:16 vers Bunny.net');
  console.log('='.repeat(60));
